...
class QuizController extends Controller
{
    ...
    public function create()
    {
        ...
        $questions = Question::all()->pluck('texte', 'id');

        $cours = Cour::ofTeacher()->get()->pluck('titre', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.quizzes.create', compact('questions', 'cours'));
    }
    ...
    public function edit(Quiz $quiz)
    {
        ...
        $quiz->load('questions', 'cours');

        return view('admin.quizzes.edit', compact('questions', 'cours', 'quiz'));
    }
