    ...
    <div style="border: solid 1px grey; padding: 20px;">
        <form method="POST" action="{{ route("admin.questions.update", [$question->id]) }}" enctype="multipart/form-data">
            ...
            <div class="{{ $errors->has('texte') ? 'has-error' : '' }}">
                ...
                <textarea style="width: 100%; padding: 4px;" name="texte" id="texte" required>{{ old('texte', $question->texte) }}</textarea>
                @if($errors->has('texte'))
            ...
            <div class="{{ $errors->has('score') ? 'has-error' : '' }}">
                ...
                <input style="width: 100%; padding: 4px;" type="number" name="score" id="score" value="{{ old('score', $question->score) }}" step="1">
                @if($errors->has('score'))
            ...
            <div class="{{ $errors->has('option_1') ? 'has-error' : '' }}">
                ...
                <input style="width: 100%; padding: 4px;" type="text" name="option_1" id="option_1" value="{{ old('option_1', $question->option_1) }}" required>
            ...
            <div class="{{ $errors->has('correct_1') ? 'has-error' : '' }}">
                <div>
                    ...
                    <input type="checkbox" name="correct_1" id="correct_1" value="1" {{ $question->correct_1 || old('correct_1', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="{{ $errors->has('option_2') ? 'has-error' : '' }}">
                ...
                <input style="width: 100%; padding: 4px;" type="text" name="option_2" id="option_2" value="{{ old('option_2', $question->option_2) }}" required>
            ...
            <div class="{{ $errors->has('correct_2') ? 'has-error' : '' }}">
                <div>
                    ...
                    <input type="checkbox" name="correct_2" id="correct_2" value="1" {{ $question->correct_2 || old('correct_2', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="{{ $errors->has('option_3') ? 'has-error' : '' }}">
                ...
                <input style="width: 100%; padding: 4px;" type="text" name="option_3" id="option_3" value="{{ old('option_3', $question->option_3) }}">
            ...
            <div class="{{ $errors->has('correct_3') ? 'has-error' : '' }}">
                <div>
                    ...
                    <input type="checkbox" name="correct_3" id="correct_3" value="1" {{ $question->correct_3 || old('correct_3', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="{{ $errors->has('option_4') ? 'has-error' : '' }}">
                ...
                <input style="width: 100%; padding: 4px;" type="text" name="option_4" id="option_4" value="{{ old('option_4', $question->option_4) }}">
            ...
            <div class="{{ $errors->has('correct_4') ? 'has-error' : '' }}">
                <div>
                    ...
                    <input type="checkbox" name="correct_4" id="correct_4" value="1" {{ $question->correct_4 || old('correct_4', 0) === 1 ? 'checked' : '' }}>
