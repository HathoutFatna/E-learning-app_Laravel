                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-Cour">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.cour.fields.enseignants') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.cour.fields.titre') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.cour.fields.description') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.cour.fields.created_at') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.cour.fields.updated_at') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
...
@endcan
  ...
  $('.datatable-Cour:not(.ajaxTable)').DataTable({ buttons: dtButtons })
